...
/* var wildPokemon = new Audio("./107-battle-vs-wild-pokemon-.mp3");
var victory = new Audio("./108-victory-vs-wild-pokemon-.mp3");
...
var Pikachu_Appear = new Audio("sounds\\Pikachu_Appear.mp3");
var Pika_Hello = new Audio("sounds\\Pika_Hello.wav");
var Call_Thunder = new Audio("sounds\\Call_Thunder.wav");
var Thunder_Hit = new Audio("sounds\\Thunder_Hit.wav");


var Pikachu_position;
var idle = false;
var idle_play = false;
var sent_out = false;

  Declare_Any_Class( "Term_Project",  
  { 'construct'( context )
      { var shapes = {  
						"quickball": new Shape_From_File("objs\\quickball.obj"),
						"summon1": new Shape_From_File("objs\\summon1.obj"),
						"summon2": new Shape_From_File("objs\\summon2.obj"),
						"summon3": new Shape_From_File("objs\\summon3.obj"),
						"Pikachu_whole": new Shape_From_File("objs\\Pikachu_whole.obj"),
						"Pika_body": new Shape_From_File("objs\\Pika_body.obj"),
						"Pika_head": new Shape_From_File("objs\\Pika_head.obj"),
						"Pika_larm": new Shape_From_File("objs\\Pika_larm.obj"),
						"Pika_lear": new Shape_From_File("objs\\Pika_lear.obj"),
						"Pika_lfoot": new Shape_From_File("objs\\Pika_lfoot.obj"),
						"Pika_lleg": new Shape_From_File("objs\\Pika_lleg.obj"),
						"Pika_rarm": new Shape_From_File("objs\\Pika_rarm.obj"),
						"Pika_rear": new Shape_From_File("objs\\Pika_rear.obj"),
						"Pika_rfoot": new Shape_From_File("objs\\Pika_rfoot.obj"),
						"Pika_rleg": new Shape_From_File("objs\\Pika_rleg.obj"),
						"Pika_tail": new Shape_From_File("objs\\Pika_tail.obj"),
						"Spark": new Shape_From_File("objs\\EffPikachuKaminariHit.obj"),
						"strip": new ThunderStrip,
						"square" : new Square, 
                        "ball": new Grid_Sphere( 25, 25 ),
						"stage": new Stage(),
						"wall": new CustomRec()};
					   
        this.submit_shapes( context, shapes );
        
        this.define_data_members( {		silver: context.shaders_in_use["Phong_Model"].material( Color(.83,.83,.83, 1 ), .2, 1,  1, 40 ),
										stagetex: context.shaders_in_use["Phong_Model"].material( Color( .5, .5, .5, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\stagetex.jpg"]),
										walltex: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\walls.jpg"]),
										floortex: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\floor.jpg"]),
										skytex: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\skies.png"]),
										quickballtex: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\quickball.png"]),
										summon1blue: context.shaders_in_use["Phong_Model"].material( Color( .41, .94, 1, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\summon1.png"]),
										summon2blue: context.shaders_in_use["Phong_Model"].material( Color( .41, .94, 1, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\summon2.png"]),	
										summon1yellow: context.shaders_in_use["Phong_Model"].material( Color( .97, .98, .34, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\summon1.png"]),
										summon2yellow: context.shaders_in_use["Phong_Model"].material( Color( .97, .98, .34, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\summon2.png"]),
										pikachu: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\pikaUVdone.png"]),
										pikachu_tail: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\pika_tailUV.png"]),
										thunder1: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\kaminari.1.png"]),
										thunder2: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\kaminari.2.png"]),
										thunder3: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\kaminari.3.png"]),
										thunder4: context.shaders_in_use["Phong_Model"].material( Color( .75, .75, .75, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\kaminari.4.png"]),
										thunderend: context.shaders_in_use["Phong_Model"].material( Color( .94, .86, .61, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\tama.png"]),
										spark: context.shaders_in_use["Phong_Model"].material( Color( .45, .30, 0, 1 ), .5, .5, .5, 40, context.textures_in_use["textures\\senkou.png"])	});
      },
	  
	  'set_Cam_Default'( model_transform, graphics_state)
	  {
		graphics_state.camera_transform = mult(  graphics_state.camera_transform, translation( .02, -.5, -.8 )  ); 
		graphics_state.camera_transform = mult(  graphics_state.camera_transform, rotation( .2, 1, 0, 0 )  );
	  },
	  
	  'draw_Wallpaper'( model_transform, graphics_state)
      { 
		
		model_transform = mult( model_transform, translation(0, -50, -75) );
		model_transform = mult( model_transform, scale(100,100,0) );
		this.shapes.wall.draw(graphics_state, model_transform, this.walltex);
		
		model_transform= identity();
		model_transform = mult( model_transform, translation(0, 50, -76) );
		model_transform = mult( model_transform, scale(100,100,0) );
		this.shapes.square.draw(graphics_state, model_transform, this.skytex);
		
		model_transform= identity();
		model_transform = mult( model_transform, rotation(-90, 1, 0, 0));
		model_transform = mult( model_transform, translation(0, -25, -50) );
		model_transform = mult( model_transform, scale(100,100,0) );
		this.shapes.square.draw(graphics_state, model_transform, this.floortex);
		
		model_transform= identity();
		model_transform = mult( model_transform, rotation(-90, 0, 1, 0));
		model_transform = mult( model_transform, translation(24, 50, -100) );
		model_transform = mult( model_transform, scale(100,100,0) );
		this.shapes.square.draw(graphics_state, model_transform, this.skytex);
		...
		model_transform= identity();
		model_transform = mult( model_transform, translation(0, 50, 124) );
		model_transform = mult( model_transform, scale(100,100,0) );
		this.shapes.square.draw(graphics_state, model_transform, this.skytex);
      },
	  
	 'draw_Stage'( model_transform, graphics_state)
      { 
		
		model_transform = mult( model_transform, translation(-25, 0, 5) );
		model_transform = mult( model_transform, scale(5,5,5) );
		this.shapes.stage.draw(graphics_state, model_transform, this.stagetex);	
      },
	  
	  'send_out_pika'(model_transform, graphics_state)
	  {

		var t = ((graphics_state.animation_time/1000)-4);
		if (t<0)		t=0;
		else			t=1.5*t;
		if (t > .9 && t<1)		Pikachu_Appear.play();
		
		if (t>0 && t<=2)
		{
			if (t>=1)		t=1;
			model_transform = mult( model_transform, translation(10-(9.5*t),30-(29.2*t),25-(29.5*t)) );
			model_transform = mult( model_transform, rotation(-50*t, 0,1,0));
			model_transform = mult( model_transform, rotation(-360*t, 1,0,0));
			model_transform = mult( model_transform, scale(.75,.75,.75) );
			this.shapes.quickball.draw( graphics_state, model_transform, this.quickballtex );
		}
		
		model_transform= identity();
		model_transform = mult( model_transform, translation(.5,3.5,-4.5) );
		model_transform = mult( model_transform, rotation(-90, 1,0,0));
		var tempDef = model_transform; 
		var u =  ((graphics_state.animation_time/1000)-4.66);
		if (u<0) u=0;

		if (u<=.75)
		{
			//blue1
			model_transform = tempDef;
			model_transform = mult( model_transform, rotation( -180*(u*2), 0,0,1) );	
			model_transform = mult( model_transform, translation(0,0,(-2.5+4*u)) );
			model_transform = mult( model_transform, scale(8*u,8*u,8*u) );	
			this.shapes.summon1.draw( graphics_state, model_transform, this.summon1blue );

			//yellow2
			model_transform = tempDef;
			model_transform = mult( model_transform, rotation( -180*(u*2), 0,0,1) );	
			model_transform = mult( model_transform, translation(0,0,(-3+13*u) ));
			model_transform = mult( model_transform, scale(15*u,15*u,20*u) );		
			this.shapes.summon2.draw( graphics_state, model_transform, this.summon2yellow );
		}
		...
		if (u<=.9)
		{
			//yellow1
			model_transform = tempDef;
			model_transform = mult( model_transform, rotation( 360*(u*2), 0,0,1) );	
			model_transform = mult( model_transform, translation(0,0,-2.5) );
			model_transform = mult( model_transform, scale(5*u,5*u,5*u) );	
			this.shapes.summon1.draw( graphics_state, model_transform, this.summon1yellow );
		}
		...
		if (u<= 1.1)
		{
			...
			//blue2
			model_transform = tempDef;
			model_transform = mult( model_transform, rotation( -270*(u*3), 0,0,1) );	
			model_transform = mult( model_transform, translation(0,0,(-3+8*u) ));
			model_transform = mult( model_transform, scale(10*u,10*u,10*u) );	
			this.shapes.summon2.draw( graphics_state, model_transform, this.summon2blue );
		}
		...
		if (u>=0 && u<=1)
		{
			model_transform = mult( model_transform, translation(.5,6-(1.75*u),-4.5) ) 
			model_transform = mult( model_transform, rotation(90+270*u, 1,0,0) );
			model_transform = mult( model_transform,  scale(1*u,1*u,1*u) );
		}
	  ...
	  'idle_pika'( model_transform, graphics_state)
      { 
		if (idle_play == false)
		{
			Pika_Hello.play();
		...
		var temp_center = Pikachu_position;
		// model_transform = identity();
		// model_transform = mult( model_transform, translation(.5,4.25,-4.5) );
		// var temp_center = model_transform;
	  ...
	  'pika_use_thunder'(model_transform, graphics_state)
	  {
		var t = ((graphics_state.animation_time/1000)-8);
		t=t*2;
		if (t<0)		t=0;
		//else if (t<2) 	t=t;
		
		if (t > .9 && t<1)		Call_Thunder.play();
		...
		if (t<2)
		{
			...
			model_transform= identity();
			model_transform = mult( model_transform, translation(.5,3.5+(1*t),-4.5) );
			model_transform = mult( model_transform, rotation(75-(60*t), 1,0,0));
			var head_center;
			var temp_center = model_transform;	
			...
			model_transform = temp_center;
			model_transform = mult( model_transform, translation(1.5,.75+(1.25*t),2) );
			model_transform = mult( model_transform, rotation(-35, 0,1,0) );
			model_transform = mult( model_transform, rotation(-90*t, 1,0,0) );
			this.shapes.Pika_larm.draw( graphics_state, model_transform, this.pikachu );
			...
			model_transform = temp_center;
			model_transform = mult( model_transform, translation(1.15+(.125*t),-.75+(-.91*t),1.1+(-.73*t)) );
			model_transform = mult( model_transform, rotation(-45+(45*t), 1,0,0) );
			model_transform = mult( model_transform, scale(1.5,1.5,1.5) );
			this.shapes.Pika_lleg.draw( graphics_state, model_transform, this.pikachu );
			
			model_transform = temp_center;
			model_transform = mult( model_transform, translation(-1.15,-.75+(-1.15*t),1.1+(-.73*t) ));
			model_transform = mult( model_transform, rotation(-45+(45*t), 1,0,0) );
			model_transform = mult( model_transform, scale(1.5,1.5,1.5) );
			this.shapes.Pika_rleg.draw( graphics_state, model_transform, this.pikachu );

			model_transform = temp_center;
			model_transform = mult( model_transform, rotation(-90+(85*t), 1,0,0) );	
			model_transform = mult( model_transform, translation(1.4,-2.85+(-1.15*t),-1.15+(1.55*t)) );
			model_transform = mult( model_transform, scale(.8,.8,.8) );	
			this.shapes.Pika_lfoot.draw( graphics_state, model_transform, this.pikachu )
			
			model_transform = temp_center;
			model_transform = mult( model_transform, rotation(-90+(85*t), 1,0,0) );	
			model_transform = mult( model_transform, translation(-1.4+(.15*t),-2.85+(-1.15*t),-1.15+(1.55*t)) );
			model_transform = mult( model_transform, scale(.8,.8,.8) );	
			this.shapes.Pika_rfoot.draw( graphics_state, model_transform, this.pikachu )
			
			model_transform = temp_center;
			model_transform = mult( model_transform, translation(-2.8+(.8*t),-.75+(3.25*t),-4.15+(1.15*t)) );
			model_transform = mult( model_transform, rotation(-45+(45*t), 1,0,0) );
			model_transform = mult( model_transform, scale(2.5,2.5,2.5) );	
			this.shapes.Pika_tail.draw( graphics_state, model_transform, this.pikachu_tail );
		}
		...
		{
			this.idle_pika(model_transform, graphics_state);
		}
		
		
		this.cloud_bolt(model_transform, graphics_state);
	  },
	 
	 'cloud_bolt'(model_transform, graphics_state)
	  {
		var t = ((graphics_state.animation_time/1000)-9);
		if (t<0)		t=0;
		else if (t<2) 	t=t/2;
		else if (t>1)	t=1;
		
		var u = ((graphics_state.animation_time/1000)-11);
		if (u<0)		u=0;
		//else if (u<1) 	u=u;
		else if (u>1)	u=1;
		
		if (u>0)		Thunder_Hit.play();
		
		if (t>0 && t<1)
		{
			if (t>.5);
				graphics_state.camera_transform = lookAt(  vec3(-.5800000000000002,13.343682026604217,48.87044111346191) , vec3(0,100+(-90*t),0), vec3(0,1,0) );
			
			model_transform= identity();
			model_transform = mult( model_transform, translation(.5,100+(-90*t),-4.5) ); //10 is y start
			model_transform = mult( model_transform, scale(5, 5, 1));
			var temp_center = model_transform;	
		
			this.shapes.strip.draw( graphics_state, model_transform, this.thunder1);

			var temp1 = model_transform;
			model_transform = mult( model_transform, translation(0,-.5,1) );
			
			model_transform = mult( model_transform, scale(.5,-.5,.5) );
			this.shapes.square.draw( graphics_state, model_transform, this.thunderend);
			model_transform = temp1;
			
			model_transform = mult( model_transform, translation(0,4,0) );
			this.shapes.strip.draw( graphics_state, model_transform, this.thunder4);
			model_transform = mult( model_transform, translation(0,4,0) );
			this.shapes.strip.draw( graphics_state, model_transform, this.thunder3);
			model_transform = mult( model_transform, translation(0,4,0) );
			this.shapes.strip.draw( graphics_state, model_transform, this.thunder2);
		}
	  
		if (u>0 && u<1)
		{
			model_transform= identity();
			model_transform = mult( model_transform, translation(.5,4,-4.5) );
			model_transform = mult( model_transform, rotation(180*u, 0,1,0));
			model_transform = mult( model_transform, scale(5,5,5) );
			this.shapes.Spark.draw( graphics_state, model_transform, this.spark);
		}
    ...
    'display'( graphics_state )
      { // Assignment 1 can start here!
		...
		var baseTime = Math.round( graphics_state.animation_time )/1000
		...
		this.draw_Wallpaper (model_transform, graphics_state);
		this.draw_Stage	(model_transform, graphics_state);
		
		if (baseTime < 1 && baseTime > .5)
			this.set_Cam_Default	(model_transform, graphics_state);
		
		else if (baseTime > 4 && baseTime < 6)
		{
			this.send_out_pika(model_transform, graphics_state);
		}
		
		else if (baseTime >= 6 && baseTime <=8)
			this.idle_pika(model_transform, graphics_state);
		
		else if ( baseTime >= 8 && baseTime <=12)
		{
			this.pika_use_thunder(model_transform, graphics_state);
		}
...
Declare_Any_Class( "Bee_Scene",  // An example of drawing a hierarchical object using a "model_transform" matrix and post-multiplication.
  { 'construct'( context )
      { var shapes = { "box" : new        Cube(), 
        ...
        this.define_data_members( { grey_material: context.shaders_in_use["Phong_Model"].material( Color(  1,  1, .3, 1 ), .2, 1, .7, 40 ),
                                     blue_material: context.shaders_in_use["Phong_Model"].material( Color( .5, .5, .3, 1 ), .2, 1,  1, 40 ) } );
      },
    'display'( graphics_state )
      { 
		this.shapes.ball.draw( graphics_state, translation( 0, 0, 3), this.grey_material );
		this.shapes.ball.draw( graphics_state, translation( 0, 0, -3), this.blue_material );
		if( ( graphics_state.animation_time / 1000 ) % 2 < 1 ) // (alternating each second)
			graphics_state.camera_transform = lookAt( [0,0,0], [0,0,-1], [0,1,0] ); // Pass in eye position, at
  ...
  { 'construct'( context )
      { this.define_data_members( { string_map:    context.globals.string_map, start_index: 0, tick: 0, visible: false, graphics_state: new Graphics_State(),
                                    text_material: context.shaders_in_use["Phong_Model"].material( 
                                                                                Color(  0, 0, 0, 1 ), 1, 0, 0, 40, context.textures_in_use["textures\\text.png"] ) } );
  ...
  { 'construct'( context ) { this.globals    = context.globals; },
    ...
    'update_strings'( user_interface_string_manager )   // Strings that this Scene_Component contributes to the UI:
      { user_interface_string_manager.string_map["time"]    = "Animation Time: " + Math.round( this.globals.graphics_state.animation_time )/1000 + "s";
		...
		user_interface_string_manager.string_map["animate"] = "FPS " + (1/(this.globals.graphics_state.animation_delta_time/1000));
      },
  }, Scene_Component );
...
Declare_Any_Class( "Bump_Map_And_Mesh_Loader",     // An example where one teapot has a bump-mapping-like hack, and the other does not.
  { 'construct'( context )
      { context.globals.animate = true;
        ...
        this.submit_shapes( context, shapes );
        this.define_data_members( { stars: context.shaders_in_use["Phong_Model"  ].material( Color( .5,.5,.5,1 ), .5, .5, .5, 40, context.textures_in_use["textures\stars.png"] ),
                                    bumps: context.shaders_in_use["Fake_Bump_Map"].material( Color( .5,.5,.5,1 ), .5, .5, .5, 40, context.textures_in_use["textures\stars.png"] )});
      },
    'display'( graphics_state )
...
Declare_Any_Class( "Simulation_Scene_Superclass",
  { 'construct'( context )
      { context.globals.animate = true;
        this.define_data_members( { bodies: [], shader: context.shaders_in_use["Phong_Model"], stars: context.textures_in_use["textures\stars.png"] } );
